...
Es un sitio web sobre unas ficticias jornadas sobre Economía Circular.

Trabajo realizado para las PEC2 de la asignatura de `Herramientas HTML y CSS ||` del `Máster Universitario en Desarrollo de sitios y aplicaciones web`.
